...
<div class="col-lg-8">
    <form method="post" action="/dashboard/artikel/{{ $artikel->slug }}" enctype="multipart/form-data" class="mb-3">
        @method('put')
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            @if ($artikel->gambar)
            <img src="{{ asset('storage/' . $artikel->gambar) }}" class="img-preview img-fluid mb-4 col-sm-6 d-block">
            @else
